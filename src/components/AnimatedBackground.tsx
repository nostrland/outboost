export default function AnimatedBackground() {
  return (
    <div aria-hidden className="fixed inset-0 overflow-hidden pointer-events-none">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_1000px_600px_at_90%_85%,rgba(255,255,255,0.055),transparent_65%)]" />

      {/* Large animated gradient orbs - Lucidity-style */}
